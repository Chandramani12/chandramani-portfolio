              ...
              <Card className="bg-background border-border/50">
                <CardContent className="p-6 flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:chandramaninet1002@gmail.com" className="text-foreground/80 hover:text-primary">
              ...
              <Card className="bg-background border-border/50">
                <CardContent className="p-6 flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919653173371" className="text-foreground/80 hover:text-primary">
                      +91 9653173371
                    </a>
                  </div>
                </CardContent>
              ...
              <Card className="bg-background border-border/50">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="rounded-full bg-muted p-3 text-foreground/80 hover:text-primary transition-colors">
